...
<button onClick={onclick}  className='btn w-[111px] bg-[#008080] hover:bg-green-600 btn-md z-10 rounded-[50px]  text-white btn-outline opacity: 0.1 lg:opacity-1 '>Get Quote</button> 
</div>
